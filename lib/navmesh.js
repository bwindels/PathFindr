...
function cutCorners(oPath) {
    ...
    parts.slice(1).forEach(function(part) {
        ...
        var coordinateName = segment.isHorizontal() ? 'x' : 'y';
        var startValue = part.startPosition[coordinateName];
        var endValue = part.endPosition[coordinateName];
        var segmentA = segment.c1[coordinateName];
        var segmentB = segment.c2[coordinateName];
        var marginA = rangeMargin(startValue, endValue, segmentA);
        var marginB = rangeMargin(startValue, endValue, segmentB);
